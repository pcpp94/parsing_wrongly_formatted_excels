...
# Capture the list of modules before any user imports
...
if __name__ == '__main__':
    ...
    user_imported_modules = {name for name in user_imported_modules if name in pkg_resources.working_set.by_key}

    # Get the versions of the imported modules
    versions = {pkg.key: pkg.version for pkg in pkg_resources.working_set if pkg.key in user_imported_modules}
